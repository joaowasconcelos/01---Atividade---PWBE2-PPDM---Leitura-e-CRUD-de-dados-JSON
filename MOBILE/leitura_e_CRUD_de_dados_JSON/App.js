...
export default function App() {
  ...
  const selecionarArquivo = async () => {
    ...
    try {
      const response = await api.post("/pessoa", dadosJSON );
      Alert.alert("Aviso", "Pessoa inserida no banco de dados")
      console.log(dados);
    } catch (error) {
  ...
  <View style={styles.container}>
    <View style={styles.containerLargura}>
      <View style={styles.topo}>
        <Text style={styles.titleConteudo}>Adicionando Pessoa no banco de dados</Text>
      </View>
